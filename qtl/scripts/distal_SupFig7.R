...
pbs_signals <- read_csv("data/eqtl/CTL_PEER_k20_genoPC_cond1Mb_topSignals_rsID.csv")
fnf_signals <- read_csv("data/eqtl/FNF_PEER_k22_genoPC_cond1Mb_topSignals_rsID.csv")
...
plotText("B", x = 4.6, y = 0.2, just = c("left", "top"), fontfamily = "Helvetica",
         fontsize = 14, fontface = "bold")
plotGG(plot = skipped_egene_barplot, x = 4.75, y = 0.25, width = 4.25, height = 2.25)
dev.off()
